"""
Django settings for round_field_39363 project.
...
ROOT_URLCONF = 'round_field_39363.urls'
...
WSGI_APPLICATION = 'round_field_39363.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "round_field_39363 API",
    "DESCRIPTION": "API documentation for round_field_39363 App",
    "VERSION": "v1",
}
